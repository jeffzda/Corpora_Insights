# Category selection for parent-archetype taxonomy — direct PM-purpose assessment
...
- `deliberated_classes` should be 5–10 classes that were close calls — borderline include/exclude decisions where you considered both options. Each entry needs a one-sentence reason.
