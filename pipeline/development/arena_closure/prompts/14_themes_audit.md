...
You are auditing a candidate parent-category set proposed for a taxonomy of failure-mode clusters extracted from a corpus of government-funded clean-energy project documents. Each cluster represents a recurring failure pattern asserted by multiple project authors. You will see:
...
```json
{
  "audit": {
    ...
    "missing_mechanism_classes": [
      {"name": "<short name>", "description": "<one sentence>", "evidence_clusters": ["<cNNN>"]}
    ]
  },
  "themes": [
    {
