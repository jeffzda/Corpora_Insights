...
- **Mechanism, not topic.** The parent's `mechanism_criterion` is the test. A cluster about a different technology that fails through the same mechanism still belongs in the parent.
